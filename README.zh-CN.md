<div align="center">
  <img src="./docs/images/github-cover-new.png" alt="Real Estate AI Agent">
  <br />
  <p>
...
Real Estate AI Agent 是一个基于 RAG (Retrieval-Augmented Generation) 技术的智能对话系统，它能够帮助构建基于自有知识库的智能问答系统。通过结合文档检索和大语言模型，实现了准确、可靠的知识问答服务。
